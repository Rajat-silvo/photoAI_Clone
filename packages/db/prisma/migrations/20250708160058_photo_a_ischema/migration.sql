...
-- CreateEnum
CREATE TYPE "EthinicityEnum" AS ENUM ('White', 'Black', 'Asian American', 'East Asian(Chinese, Japanese, Korean)', 'South East Asian(Thai, Indonesian)', 'South Asian(Indian)', 'Middle Eastern(Arabic)', 'Pacific(Polynesian)', 'Hispanic(Latin American)', 'Other');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Brown', 'Blue', 'Green', 'Hazel', 'Gray', 'Amber', 'Other');

-- CreateEnum
CREATE TYPE "OutputImagesStatusEnum" AS ENUM ('Pending', 'Processing', 'Generated', 'Failed');
...
CREATE TABLE "OutputImages" (
    ...
    "status" "OutputImagesStatusEnum" NOT NULL DEFAULT 'Pending',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
